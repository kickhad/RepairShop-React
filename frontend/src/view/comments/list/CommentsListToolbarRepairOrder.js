    ...
    return (
      <ToolbarWrapper>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Button
            component={Link}
            to="/audit-logs?entityNames=comments"
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: commentsSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: commentsSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(CommentsToolbar);
