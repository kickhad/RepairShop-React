...
import CommentsFormModal from 'view/comments/form/CommentsFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/comments/commentsSelectors';

class CommentsAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return CommentsService.listAutocomplete(value, limit);
  };
