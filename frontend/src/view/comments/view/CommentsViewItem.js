...
import selectors from 'modules/comments/commentsSelectors';
import MaterialLink from '@material-ui/core/Link';
import { Typography } from '@material-ui/core';

class CommentsViewItem extends Component {
  valueAsArray = () => {
...
export default connect(select)(CommentsViewItem);
