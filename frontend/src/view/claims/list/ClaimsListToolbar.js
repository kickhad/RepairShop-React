...
import claimsSelectors from 'modules/claims/claimsSelectors';
import destroyActions from 'modules/claims/destroy/claimsDestroyActions';
import destroySelectors from 'modules/claims/destroy/claimsDestroySelectors';
import actions from 'modules/claims/list/claimsListActions';
import selectors from 'modules/claims/list/claimsListSelectors';
...
class ClaimsToolbar extends Component {
  state = {
    ...
    return (
      <ToolbarWrapper>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Button
            component={Link}
            to="/audit-logs?entityNames=claims"
...
function select(state) {
  return {
    ...
    hasPermissionToEdit: claimsSelectors.selectPermissionToEdit(
      state,
    ),
    hasPermissionToDestroy: claimsSelectors.selectPermissionToDestroy(
      state,
    ),
    hasPermissionToCreate: claimsSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: claimsSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(ClaimsToolbar);
