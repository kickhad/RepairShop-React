    ...
    return (
      <ToolbarWrapper>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Button
            component={Link}
            to="/audit-logs?entityNames=images"
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: imagesSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: imagesSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(ImagesToolbar);
