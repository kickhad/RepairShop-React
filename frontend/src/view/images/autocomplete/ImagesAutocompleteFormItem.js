...
import ImagesFormModal from 'view/images/form/ImagesFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/images/imagesSelectors';

class ImagesAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return ImagesService.listAutocomplete(value, limit);
  };
