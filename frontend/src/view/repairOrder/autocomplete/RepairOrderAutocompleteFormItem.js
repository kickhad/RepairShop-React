...
import RepairOrderFormModal from 'view/repairOrder/form/RepairOrderFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/repairOrder/repairOrderSelectors';

class RepairOrderAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return RepairOrderService.listAutocomplete(value, limit);
  };
...
export default connect(select)(
  RepairOrderAutocompleteFormItem,
);
