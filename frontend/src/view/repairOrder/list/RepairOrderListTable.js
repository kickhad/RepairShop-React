...
import destroyActions from 'modules/repairOrder/destroy/repairOrderDestroyActions';
import selectors from 'modules/repairOrder/list/repairOrderListSelectors';
import destroySelectors from 'modules/repairOrder/destroy/repairOrderDestroySelectors';
import model from 'modules/repairOrder/repairOrderModel';
import repairOrderSelectors from 'modules/repairOrder/repairOrderSelectors';
...
import DeviceListItem from 'view/device/list/DeviceListItem';
import CommentsListItem from 'view/comments/list/CommentsListItem';
import ClaimsListItem from 'view/claims/list/ClaimsListItem';

const { fields } = model;

class RepairOrderListTable extends Component {
  state = {
              ...
              {!loading &&
                rows.map((row) => (
                  <TableRow key={row.id}>
                    ...
                    <TableCell>
                      <DeviceListItem value={row[fields.products.name]} />
                    </TableCell>
                    <TableCell>
                      <UserListItem value={row[fields.assignedTech.name]} />
                    </TableCell>
                    <TableCell>
                      <FilesListView value={row[fields.attachments.name]} />
                    </TableCell>
                    <TableCell>
                      <CommentsListItem value={row[fields.comments.name]} />
                    </TableCell>
                    <TableCell>
                      <ClaimsListItem value={row[fields.warrantyClaim.name]} />
                    </TableCell>
                    <TableCell>
...
function select(state) {
  return {
    ...
    hasPermissionToEdit: repairOrderSelectors.selectPermissionToEdit(
      state,
    ),
    hasPermissionToDestroy: repairOrderSelectors.selectPermissionToDestroy(
      state,
    ),
  };
}

export default connect(select)(RepairOrderListTable);
