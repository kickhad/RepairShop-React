...
class RepairOrderToolbar extends Component {
  state = {
    ...
    return (
      <ToolbarWrapper>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Button
            component={Link}
            to="/audit-logs?entityNames=repairOrder"
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: repairOrderSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: repairOrderSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(RepairOrderToolbar);
