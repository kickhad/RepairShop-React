...
import selectors from 'modules/repairOrder/repairOrderSelectors';
import MaterialLink from '@material-ui/core/Link';
import { Typography } from '@material-ui/core';

class RepairOrderViewItem extends Component {
  valueAsArray = () => {
...
export default connect(select)(RepairOrderViewItem);
