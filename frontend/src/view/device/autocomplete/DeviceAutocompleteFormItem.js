...
import DeviceFormModal from 'view/device/form/DeviceFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/device/deviceSelectors';

class DeviceAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  mapper = {
    toAutocomplete(originalValue) {
      ...
      if (originalValue['printerBrand']) {
        label = originalValue['printerBrand'];
      }
