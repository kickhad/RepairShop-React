...
function select(state) {
  return {
    ...
    hasPermissionToCreate: deviceSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: deviceSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(DeviceToolbar);
