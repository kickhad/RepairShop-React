...
import exporterFields from 'modules/repairOrder/list/repairOrderListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'REPAIRORDER_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await RepairOrderService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.repairOrder.exporterFileName'),
