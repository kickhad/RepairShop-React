...
module.exports = class ImagesService {
  ...
  /**
   * Destroy all Imagess with those ids.
   *
   * @param {*} ids
   */
  ...
  /**
   * Finds Imagess for Autocomplete.
   *
   * @param {*} search
   * @param {*} limit
   */
  ...
  /**
   * Finds Imagess based on the query.
   *
   * @param {*} args
   */
