...
module.exports = class CommentsService {
  ...
  /**
   * Destroy all Commentss with those ids.
   *
   * @param {*} ids
   */
  ...
  /**
   * Finds Commentss for Autocomplete.
   *
   * @param {*} search
   * @param {*} limit
   */
  ...
  /**
   * Finds Commentss based on the query.
   *
   * @param {*} args
   */
